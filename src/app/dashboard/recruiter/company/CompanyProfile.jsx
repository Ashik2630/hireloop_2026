...
export default function CompanyProfile({ recruiter, recruiterCompany  }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const newCompanyData = {
      ...
      status: company?.status || "Pending", // Retains status if updating profile details
      recruiterId: recruiter?.id // Associate the recruiter ID for ownership,
    };
    ...
    } else if (payload?.modifiedCount > 0 || payload?.acknowledged) {
